...
router.post("/", (req, res) => {
  ...
  connection.query(mysqlll, (err, result, files, rows) => {
    if (err) {
      console.log('error query create db' + err.message);
    } else {
